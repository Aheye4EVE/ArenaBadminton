      ...
      <div className="guilds-shell">
        <form className="guilds-search-form" method="get">
          <div className="guilds-searchbar">
            ...
            <button type="submit" className="guild-primary-action"><Search size={16} /> ค้นหา Guild</button>
          </div>
          <details className="guilds-advanced-filter" open={Boolean(filters.province || filters.district || filters.subdistrict)}>
            ...
            <div className="guilds-advanced-filter__body">
              ...
              <div className="guilds-filter-actions"><Link href="/guilds" className="guild-secondary-action"><RotateCcw size={15} /> ล้างตัวกรอง</Link><button type="submit" className="guild-primary-action"><Filter size={15} /> ใช้ตัวกรอง</button></div>
            </div>
          </details>
        </form>
        ...
        <footer className="guilds-footer"><Link href="/">Arena-Badminton</Link><span>Guild · Member system · RPG progression</span></footer>
      </div>
    </main>
  );
}

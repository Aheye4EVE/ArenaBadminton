...
import { ArrowLeft, ArrowRight, CalendarDays, Check, Crown, Megaphone, Shield, ShieldCheck, UserMinus, Users, X } from "lucide-react";
...
export default function GuildDetail({ guild, members, announcements, requests, membership, pendingRequest }: { guild: GuildData; members: GuildMemberData[]; announcements: GuildAnnouncementData[]; requests: GuildJoinRequestData[]; membership: { role: string; membershipStatus: string } | null; pendingRequest: boolean }) {

...
export default function RankingBrowser({ entries, totalPlayers, currentUserId }: { entries: RankingEntry[]; totalPlayers: number; currentUserId: string | null }) {
